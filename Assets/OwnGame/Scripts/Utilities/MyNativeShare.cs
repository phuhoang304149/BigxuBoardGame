...
// 	public static void ShareScreenshotWithText (this MonoBehaviour _monoBehaviour, string text)
// 	{
...
// 		_monoBehaviour.StartCoroutine (DelayedShare (screenShotPath, text));
// 	}
...
// 	static IEnumerator DelayedShare (string screenShotPath, string text)
// 	{
...
// 	{
// #if UNITY_EDITOR
// 		Debug.Log("No sharing set up for UNITY EDITOR.");
// #elif UNITY_ANDROID
