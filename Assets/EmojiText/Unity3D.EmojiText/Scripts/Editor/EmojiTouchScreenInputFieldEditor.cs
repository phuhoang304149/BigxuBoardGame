...
namespace EmojiUI
{
	...
	public class EmojiTouchScreenInputFieldEditor : Editor
	{
		...
		GUIContent lbRawTextComponent;
		SerializedProperty propRawTextComponent;
		...
		void OnEnable()
		{
			...
			lbRawTextComponent = new GUIContent("Raw Text Component");
			propRawTextComponent = serializedObject.FindProperty("m_RawTextComponent");
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(propRawTextComponent, lbRawTextComponent);
