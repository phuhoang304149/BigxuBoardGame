...
public class Poker_MyBar_PanelBetDetail_Controller : MonoBehaviour ,IPointerUpHandler, IPointerDownHandler {

	[SerializeField] CanvasGroup myCanvasGroup;
	[SerializeField] CanvasGroup canvasGroupShadow;
	public Slider betDetailSlider;
	public InputField betDetailInputField;
	public Text txtRealBetDetailInfo;
	...
	private void Awake() {
		...
		betDetailSlider.value = 0f;
		betDetailInputField.text = string.Empty;
	}
